...
if(this.opened){this.focus()}},_transitionEnd:function _transitionEnd(){this.style[this._dimensionMax]=this._desiredSize;this.toggleClass("iron-collapse-closed",!this.opened);this.toggleClass("iron-collapse-opened",this.opened);this._updateTransition(!1);this.notifyResize();this._setTransitioning(!1)},_onTransitionEnd:function _onTransitionEnd(event){if(dom(event).rootTarget===this){this._transitionEnd()}},_calcSize:function _calcSize(){return this.getBoundingClientRect()[this.dimension]+"px"},ready:function ready(){this.$.content.innerHTML=this.answer}});var $_documentContainer$1=document.createElement("template");$_documentContainer$1.setAttribute("style","display: none;");$_documentContainer$1.innerHTML="<custom-style>\n  <style is=\"custom-style\">\n    html {\n\n      --shadow-transition: {\n        transition: box-shadow 0.28s cubic-bezier(0.4, 0, 0.2, 1);\n      };\n\n      --shadow-none: {\n        box-shadow: none;\n      };\n\n      /* from http://codepen.io/shyndman/pen/c5394ddf2e8b2a5c9185904b57421cdb */\n\n      --shadow-elevation-2dp: {\n        box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.14),\n                    0 1px 5px 0 rgba(0, 0, 0, 0.12),\n                    0 3px 1px -2px rgba(0, 0, 0, 0.2);\n      };\n\n      --shadow-elevation-3dp: {\n        box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.14),\n                    0 1px 8px 0 rgba(0, 0, 0, 0.12),\n                    0 3px 3px -2px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-4dp: {\n        box-shadow: 0 4px 5px 0 rgba(0, 0, 0, 0.14),\n                    0 1px 10px 0 rgba(0, 0, 0, 0.12),\n                    0 2px 4px -1px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-6dp: {\n        box-shadow: 0 6px 10px 0 rgba(0, 0, 0, 0.14),\n                    0 1px 18px 0 rgba(0, 0, 0, 0.12),\n                    0 3px 5px -1px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-8dp: {\n        box-shadow: 0 8px 10px 1px rgba(0, 0, 0, 0.14),\n                    0 3px 14px 2px rgba(0, 0, 0, 0.12),\n                    0 5px 5px -3px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-12dp: {\n        box-shadow: 0 12px 16px 1px rgba(0, 0, 0, 0.14),\n                    0 4px 22px 3px rgba(0, 0, 0, 0.12),\n                    0 6px 7px -4px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-16dp: {\n        box-shadow: 0 16px 24px 2px rgba(0, 0, 0, 0.14),\n                    0  6px 30px 5px rgba(0, 0, 0, 0.12),\n                    0  8px 10px -5px rgba(0, 0, 0, 0.4);\n      };\n\n      --shadow-elevation-24dp: {\n        box-shadow: 0 24px 38px 3px rgba(0, 0, 0, 0.14),\n                    0 9px 46px 8px rgba(0, 0, 0, 0.12),\n                    0 11px 15px -7px rgba(0, 0, 0, 0.4);\n      };\n    }\n  </style>\n</custom-style>";document.head.appendChild($_documentContainer$1.content);/**
                                                          ...
                                                          */ /*
                                                               ...
                                                               from HTML and may be out of place here. Review them and
                                                               then delete this comment!
                                                             */;Polymer({_template:html(_templateObject2_f273f6d02caa11ea91a843ae9cba1c4a()),is:"simple-expand-collapse",properties:{horizontal:{type:Boolean},opened:{type:Boolean,reflectToAttribute:!0},question:{type:String},answer:{type:String},noAnimation:{type:Boolean}},toggle:function toggle(){this.$.collapse.toggle()},_getText:function _getText(opened){return opened?"expand-less":"expand-more"}});var $_documentContainer$2=document.createElement("template");$_documentContainer$2.setAttribute("style","display: none;");$_documentContainer$2.innerHTML="<custom-style>\n  <style is=\"custom-style\">\n    [hidden] {\n      display: none !important;\n    }\n  </style>\n</custom-style><custom-style>\n  <style is=\"custom-style\">\n    html {\n\n      --layout: {\n        display: -ms-flexbox;\n        display: -webkit-flex;\n        display: flex;\n      };\n\n      --layout-inline: {\n        display: -ms-inline-flexbox;\n        display: -webkit-inline-flex;\n        display: inline-flex;\n      };\n\n      --layout-horizontal: {\n        @apply --layout;\n\n        -ms-flex-direction: row;\n        -webkit-flex-direction: row;\n        flex-direction: row;\n      };\n\n      --layout-horizontal-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: row-reverse;\n        -webkit-flex-direction: row-reverse;\n        flex-direction: row-reverse;\n      };\n\n      --layout-vertical: {\n        @apply --layout;\n\n        -ms-flex-direction: column;\n        -webkit-flex-direction: column;\n        flex-direction: column;\n      };\n\n      --layout-vertical-reverse: {\n        @apply --layout;\n\n        -ms-flex-direction: column-reverse;\n        -webkit-flex-direction: column-reverse;\n        flex-direction: column-reverse;\n      };\n\n      --layout-wrap: {\n        -ms-flex-wrap: wrap;\n        -webkit-flex-wrap: wrap;\n        flex-wrap: wrap;\n      };\n\n      --layout-wrap-reverse: {\n        -ms-flex-wrap: wrap-reverse;\n        -webkit-flex-wrap: wrap-reverse;\n        flex-wrap: wrap-reverse;\n      };\n\n      --layout-flex-auto: {\n        -ms-flex: 1 1 auto;\n        -webkit-flex: 1 1 auto;\n        flex: 1 1 auto;\n      };\n\n      --layout-flex-none: {\n        -ms-flex: none;\n        -webkit-flex: none;\n        flex: none;\n      };\n\n      --layout-flex: {\n        -ms-flex: 1 1 0.000000001px;\n        -webkit-flex: 1;\n        flex: 1;\n        -webkit-flex-basis: 0.000000001px;\n        flex-basis: 0.000000001px;\n      };\n\n      --layout-flex-2: {\n        -ms-flex: 2;\n        -webkit-flex: 2;\n        flex: 2;\n      };\n\n      --layout-flex-3: {\n        -ms-flex: 3;\n        -webkit-flex: 3;\n        flex: 3;\n      };\n\n      --layout-flex-4: {\n        -ms-flex: 4;\n        -webkit-flex: 4;\n        flex: 4;\n      };\n\n      --layout-flex-5: {\n        -ms-flex: 5;\n        -webkit-flex: 5;\n        flex: 5;\n      };\n\n      --layout-flex-6: {\n        -ms-flex: 6;\n        -webkit-flex: 6;\n        flex: 6;\n      };\n\n      --layout-flex-7: {\n        -ms-flex: 7;\n        -webkit-flex: 7;\n        flex: 7;\n      };\n\n      --layout-flex-8: {\n        -ms-flex: 8;\n        -webkit-flex: 8;\n        flex: 8;\n      };\n\n      --layout-flex-9: {\n        -ms-flex: 9;\n        -webkit-flex: 9;\n        flex: 9;\n      };\n\n      --layout-flex-10: {\n        -ms-flex: 10;\n        -webkit-flex: 10;\n        flex: 10;\n      };\n\n      --layout-flex-11: {\n        -ms-flex: 11;\n        -webkit-flex: 11;\n        flex: 11;\n      };\n\n      --layout-flex-12: {\n        -ms-flex: 12;\n        -webkit-flex: 12;\n        flex: 12;\n      };\n\n      /* alignment in cross axis */\n\n      --layout-start: {\n        -ms-flex-align: start;\n        -webkit-align-items: flex-start;\n        align-items: flex-start;\n      };\n\n      --layout-center: {\n        -ms-flex-align: center;\n        -webkit-align-items: center;\n        align-items: center;\n      };\n\n      --layout-end: {\n        -ms-flex-align: end;\n        -webkit-align-items: flex-end;\n        align-items: flex-end;\n      };\n\n      --layout-baseline: {\n        -ms-flex-align: baseline;\n        -webkit-align-items: baseline;\n        align-items: baseline;\n      };\n\n      /* alignment in main axis */\n\n      --layout-start-justified: {\n        -ms-flex-pack: start;\n        -webkit-justify-content: flex-start;\n        justify-content: flex-start;\n      };\n\n      --layout-center-justified: {\n        -ms-flex-pack: center;\n        -webkit-justify-content: center;\n        justify-content: center;\n      };\n\n      --layout-end-justified: {\n        -ms-flex-pack: end;\n        -webkit-justify-content: flex-end;\n        justify-content: flex-end;\n      };\n\n      --layout-around-justified: {\n        -ms-flex-pack: distribute;\n        -webkit-justify-content: space-around;\n        justify-content: space-around;\n      };\n\n      --layout-justified: {\n        -ms-flex-pack: justify;\n        -webkit-justify-content: space-between;\n        justify-content: space-between;\n      };\n\n      --layout-center-center: {\n        @apply --layout-center;\n        @apply --layout-center-justified;\n      };\n\n      /* self alignment */\n\n      --layout-self-start: {\n        -ms-align-self: flex-start;\n        -webkit-align-self: flex-start;\n        align-self: flex-start;\n      };\n\n      --layout-self-center: {\n        -ms-align-self: center;\n        -webkit-align-self: center;\n        align-self: center;\n      };\n\n      --layout-self-end: {\n        -ms-align-self: flex-end;\n        -webkit-align-self: flex-end;\n        align-self: flex-end;\n      };\n\n      --layout-self-stretch: {\n        -ms-align-self: stretch;\n        -webkit-align-self: stretch;\n        align-self: stretch;\n      };\n\n      --layout-self-baseline: {\n        -ms-align-self: baseline;\n        -webkit-align-self: baseline;\n        align-self: baseline;\n      };\n\n      /* multi-line alignment in main axis */\n\n      --layout-start-aligned: {\n        -ms-flex-line-pack: start;  /* IE10 */\n        -ms-align-content: flex-start;\n        -webkit-align-content: flex-start;\n        align-content: flex-start;\n      };\n\n      --layout-end-aligned: {\n        -ms-flex-line-pack: end;  /* IE10 */\n        -ms-align-content: flex-end;\n        -webkit-align-content: flex-end;\n        align-content: flex-end;\n      };\n\n      --layout-center-aligned: {\n        -ms-flex-line-pack: center;  /* IE10 */\n        -ms-align-content: center;\n        -webkit-align-content: center;\n        align-content: center;\n      };\n\n      --layout-between-aligned: {\n        -ms-flex-line-pack: justify;  /* IE10 */\n        -ms-align-content: space-between;\n        -webkit-align-content: space-between;\n        align-content: space-between;\n      };\n\n      --layout-around-aligned: {\n        -ms-flex-line-pack: distribute;  /* IE10 */\n        -ms-align-content: space-around;\n        -webkit-align-content: space-around;\n        align-content: space-around;\n      };\n\n      /*******************************\n                Other Layout\n      *******************************/\n\n      --layout-block: {\n        display: block;\n      };\n\n      --layout-invisible: {\n        visibility: hidden !important;\n      };\n\n      --layout-relative: {\n        position: relative;\n      };\n\n      --layout-fit: {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-scroll: {\n        -webkit-overflow-scrolling: touch;\n        overflow: auto;\n      };\n\n      --layout-fullbleed: {\n        margin: 0;\n        height: 100vh;\n      };\n\n      /* fixed position */\n\n      --layout-fixed-top: {\n        position: fixed;\n        top: 0;\n        left: 0;\n        right: 0;\n      };\n\n      --layout-fixed-right: {\n        position: fixed;\n        top: 0;\n        right: 0;\n        bottom: 0;\n      };\n\n      --layout-fixed-bottom: {\n        position: fixed;\n        right: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n      --layout-fixed-left: {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 0;\n      };\n\n    }\n  </style>\n</custom-style>";document.head.appendChild($_documentContainer$2.content);var style=document.createElement("style");style.textContent="[hidden] { display: none !important; }";document.head.appendChild(style);var IronMeta=function IronMeta(options){IronMeta[" "](options);this.type=options&&options.type||"default";this.key=options&&options.key;if(options&&"value"in options){this.value=options.value}};// This function is used to convince Closure not to remove constructor calls
...
_exports.IronMeta=IronMeta;IronMeta[" "]=function(){};IronMeta.types={};IronMeta.prototype={get value(){var type=this.type,key=this.key;if(type&&key){return IronMeta.types[type]&&IronMeta.types[type][key]}},set value(value){var type=this.type,key=this.key;if(type&&key){type=IronMeta.types[type]=IronMeta.types[type]||{};if(null==value){delete type[key]}else{type[key]=value}}},get list(){var type=this.type;if(type){var items=IronMeta.types[this.type];if(!items){return[]}return Object.keys(items).map(function(key){return metaDatas[this.type][key]},this)}},byKey:function byKey(key){this.key=key;return this.value}};var metaDatas=IronMeta.types;Polymer({is:"iron-meta",properties:{/**
   ...
   * @return {*}
   */byKey:function byKey(key){return new IronMeta({type:this.type,key:key}).value}});var ironMeta={IronMeta:IronMeta};_exports.$ironMeta=ironMeta;Polymer({_template:html(_templateObject3_f273f6d02caa11ea91a843ae9cba1c4a()),is:"iron-icon",properties:{/**
     ...
     */_meta:{value:Base.create("iron-meta",{type:"iconset"})}},observers:["_updateIcon(_meta, isAttached)","_updateIcon(theme, isAttached)","_srcChanged(src, isAttached)","_iconChanged(icon, isAttached)"],_DEFAULT_ICONSET:"icons",_iconChanged:function _iconChanged(icon){var parts=(icon||"").split(":");this._iconName=parts.pop();this._iconsetName=parts.pop()||this._DEFAULT_ICONSET;this._updateIcon()},_srcChanged:function _srcChanged(src){this._updateIcon()},_usesIconset:function _usesIconset(){return this.icon||!this.src},/** @suppress {visibility} */_updateIcon:function _updateIcon(){if(this._usesIconset()){if(this._img&&this._img.parentNode){dom(this.root).removeChild(this._img)}if(""===this._iconName){if(this._iconset){this._iconset.removeIcon(this)}}else if(this._iconsetName&&this._meta){this._iconset=/** @type {?Polymer.Iconset} */this._meta.byKey(this._iconsetName);if(this._iconset){this._iconset.applyIcon(this,this._iconName,this.theme);this.unlisten(window,"iron-iconset-added","_updateIcon")}else{this.listen(window,"iron-iconset-added","_updateIcon")}}}else{if(this._iconset){this._iconset.removeIcon(this)}if(!this._img){this._img=document.createElement("img");this._img.style.width="100%";this._img.style.height="100%";this._img.draggable=!1}this._img.src=this.src;dom(this.root).appendChild(this._img)}}});var template=html(_templateObject4_f273f6d02caa11ea91a843ae9cba1c4a());document.head.appendChild(template.content);Polymer({is:"iron-iconset-svg",properties:{/**
...
// shadow-root
svg.style.cssText=cssText;svg.appendChild(content).removeAttribute("id");return svg}return null}});Polymer({_template:html(_templateObject5_f273f6d02caa11ea91a843ae9cba1c4a()),is:"iron-image",properties:{/**
     * The URL of an image.
...
resolved=(location.origin||location.protocol+"//"+location.host)+resolved}return resolved}});var IronSelection=function IronSelection(selectCallback){this.selection=[];this.selectCallback=selectCallback};_exports.IronSelection=IronSelection;IronSelection.prototype={/**
...
var domContainer=dom(this._rippleContainer||this),target=dom(optTriggeringEvent).rootTarget;if(domContainer.deepContains(/** @type {Node} */target)){this._ripple.uiDownAction(optTriggeringEvent)}}}},/**
   ...
   */_createRipple:function _createRipple(){var element=/** @type {!PaperRippleElement} */document.createElement("paper-ripple");return element},_noinkChanged:function _noinkChanged(noink){if(this.hasRipple()){this._ripple.noink=noink}}};_exports.PaperRippleBehavior=PaperRippleBehavior;var paperRippleBehavior={PaperRippleBehavior:PaperRippleBehavior};_exports.$paperRippleBehavior=paperRippleBehavior;var PaperInkyFocusBehaviorImpl={observers:["_focusedChanged(receivedFocusFromKeyboard)"],_focusedChanged:function _focusedChanged(receivedFocusFromKeyboard){if(receivedFocusFromKeyboard){this.ensureRipple()}if(this.hasRipple()){this._ripple.holdDown=receivedFocusFromKeyboard}},_createRipple:function _createRipple(){var ripple=PaperRippleBehavior._createRipple();ripple.id="ink";ripple.setAttribute("center","");ripple.classList.add("circle");return ripple}};/** @polymerBehavior Polymer.PaperInkyFocusBehavior */_exports.PaperInkyFocusBehaviorImpl=PaperInkyFocusBehaviorImpl;var PaperInkyFocusBehavior=[IronButtonState,IronControlState,PaperRippleBehavior,PaperInkyFocusBehaviorImpl];_exports.PaperInkyFocusBehavior=PaperInkyFocusBehavior;var paperInkyFocusBehavior={PaperInkyFocusBehaviorImpl:PaperInkyFocusBehaviorImpl,PaperInkyFocusBehavior:PaperInkyFocusBehavior};_exports.$paperInkyFocusBehavior=paperInkyFocusBehavior;var $_documentContainer$3=document.createElement("template");$_documentContainer$3.setAttribute("style","display: none;");$_documentContainer$3.innerHTML="<custom-style>\n  <style is=\"custom-style\">\n    html {\n\n      /* Material Design color palette for Google products */\n\n      --google-red-100: #f4c7c3;\n      --google-red-300: #e67c73;\n      --google-red-500: #db4437;\n      --google-red-700: #c53929;\n\n      --google-blue-100: #c6dafc;\n      --google-blue-300: #7baaf7;\n      --google-blue-500: #4285f4;\n      --google-blue-700: #3367d6;\n\n      --google-green-100: #b7e1cd;\n      --google-green-300: #57bb8a;\n      --google-green-500: #0f9d58;\n      --google-green-700: #0b8043;\n\n      --google-yellow-100: #fce8b2;\n      --google-yellow-300: #f7cb4d;\n      --google-yellow-500: #f4b400;\n      --google-yellow-700: #f09300;\n\n      --google-grey-100: #f5f5f5;\n      --google-grey-300: #e0e0e0;\n      --google-grey-500: #9e9e9e;\n      --google-grey-700: #616161;\n\n      /* Material Design color palette from online spec document */\n\n      --paper-red-50: #ffebee;\n      --paper-red-100: #ffcdd2;\n      --paper-red-200: #ef9a9a;\n      --paper-red-300: #e57373;\n      --paper-red-400: #ef5350;\n      --paper-red-500: #f44336;\n      --paper-red-600: #e53935;\n      --paper-red-700: #d32f2f;\n      --paper-red-800: #c62828;\n      --paper-red-900: #b71c1c;\n      --paper-red-a100: #ff8a80;\n      --paper-red-a200: #ff5252;\n      --paper-red-a400: #ff1744;\n      --paper-red-a700: #d50000;\n\n      --paper-pink-50: #fce4ec;\n      --paper-pink-100: #f8bbd0;\n      --paper-pink-200: #f48fb1;\n      --paper-pink-300: #f06292;\n      --paper-pink-400: #ec407a;\n      --paper-pink-500: #e91e63;\n      --paper-pink-600: #d81b60;\n      --paper-pink-700: #c2185b;\n      --paper-pink-800: #ad1457;\n      --paper-pink-900: #880e4f;\n      --paper-pink-a100: #ff80ab;\n      --paper-pink-a200: #ff4081;\n      --paper-pink-a400: #f50057;\n      --paper-pink-a700: #c51162;\n\n      --paper-purple-50: #f3e5f5;\n      --paper-purple-100: #e1bee7;\n      --paper-purple-200: #ce93d8;\n      --paper-purple-300: #ba68c8;\n      --paper-purple-400: #ab47bc;\n      --paper-purple-500: #9c27b0;\n      --paper-purple-600: #8e24aa;\n      --paper-purple-700: #7b1fa2;\n      --paper-purple-800: #6a1b9a;\n      --paper-purple-900: #4a148c;\n      --paper-purple-a100: #ea80fc;\n      --paper-purple-a200: #e040fb;\n      --paper-purple-a400: #d500f9;\n      --paper-purple-a700: #aa00ff;\n\n      --paper-deep-purple-50: #ede7f6;\n      --paper-deep-purple-100: #d1c4e9;\n      --paper-deep-purple-200: #b39ddb;\n      --paper-deep-purple-300: #9575cd;\n      --paper-deep-purple-400: #7e57c2;\n      --paper-deep-purple-500: #673ab7;\n      --paper-deep-purple-600: #5e35b1;\n      --paper-deep-purple-700: #512da8;\n      --paper-deep-purple-800: #4527a0;\n      --paper-deep-purple-900: #311b92;\n      --paper-deep-purple-a100: #b388ff;\n      --paper-deep-purple-a200: #7c4dff;\n      --paper-deep-purple-a400: #651fff;\n      --paper-deep-purple-a700: #6200ea;\n\n      --paper-indigo-50: #e8eaf6;\n      --paper-indigo-100: #c5cae9;\n      --paper-indigo-200: #9fa8da;\n      --paper-indigo-300: #7986cb;\n      --paper-indigo-400: #5c6bc0;\n      --paper-indigo-500: #3f51b5;\n      --paper-indigo-600: #3949ab;\n      --paper-indigo-700: #303f9f;\n      --paper-indigo-800: #283593;\n      --paper-indigo-900: #1a237e;\n      --paper-indigo-a100: #8c9eff;\n      --paper-indigo-a200: #536dfe;\n      --paper-indigo-a400: #3d5afe;\n      --paper-indigo-a700: #304ffe;\n\n      --paper-blue-50: #e3f2fd;\n      --paper-blue-100: #bbdefb;\n      --paper-blue-200: #90caf9;\n      --paper-blue-300: #64b5f6;\n      --paper-blue-400: #42a5f5;\n      --paper-blue-500: #2196f3;\n      --paper-blue-600: #1e88e5;\n      --paper-blue-700: #1976d2;\n      --paper-blue-800: #1565c0;\n      --paper-blue-900: #0d47a1;\n      --paper-blue-a100: #82b1ff;\n      --paper-blue-a200: #448aff;\n      --paper-blue-a400: #2979ff;\n      --paper-blue-a700: #2962ff;\n\n      --paper-light-blue-50: #e1f5fe;\n      --paper-light-blue-100: #b3e5fc;\n      --paper-light-blue-200: #81d4fa;\n      --paper-light-blue-300: #4fc3f7;\n      --paper-light-blue-400: #29b6f6;\n      --paper-light-blue-500: #03a9f4;\n      --paper-light-blue-600: #039be5;\n      --paper-light-blue-700: #0288d1;\n      --paper-light-blue-800: #0277bd;\n      --paper-light-blue-900: #01579b;\n      --paper-light-blue-a100: #80d8ff;\n      --paper-light-blue-a200: #40c4ff;\n      --paper-light-blue-a400: #00b0ff;\n      --paper-light-blue-a700: #0091ea;\n\n      --paper-cyan-50: #e0f7fa;\n      --paper-cyan-100: #b2ebf2;\n      --paper-cyan-200: #80deea;\n      --paper-cyan-300: #4dd0e1;\n      --paper-cyan-400: #26c6da;\n      --paper-cyan-500: #00bcd4;\n      --paper-cyan-600: #00acc1;\n      --paper-cyan-700: #0097a7;\n      --paper-cyan-800: #00838f;\n      --paper-cyan-900: #006064;\n      --paper-cyan-a100: #84ffff;\n      --paper-cyan-a200: #18ffff;\n      --paper-cyan-a400: #00e5ff;\n      --paper-cyan-a700: #00b8d4;\n\n      --paper-teal-50: #e0f2f1;\n      --paper-teal-100: #b2dfdb;\n      --paper-teal-200: #80cbc4;\n      --paper-teal-300: #4db6ac;\n      --paper-teal-400: #26a69a;\n      --paper-teal-500: #009688;\n      --paper-teal-600: #00897b;\n      --paper-teal-700: #00796b;\n      --paper-teal-800: #00695c;\n      --paper-teal-900: #004d40;\n      --paper-teal-a100: #a7ffeb;\n      --paper-teal-a200: #64ffda;\n      --paper-teal-a400: #1de9b6;\n      --paper-teal-a700: #00bfa5;\n\n      --paper-green-50: #e8f5e9;\n      --paper-green-100: #c8e6c9;\n      --paper-green-200: #a5d6a7;\n      --paper-green-300: #81c784;\n      --paper-green-400: #66bb6a;\n      --paper-green-500: #4caf50;\n      --paper-green-600: #43a047;\n      --paper-green-700: #388e3c;\n      --paper-green-800: #2e7d32;\n      --paper-green-900: #1b5e20;\n      --paper-green-a100: #b9f6ca;\n      --paper-green-a200: #69f0ae;\n      --paper-green-a400: #00e676;\n      --paper-green-a700: #00c853;\n\n      --paper-light-green-50: #f1f8e9;\n      --paper-light-green-100: #dcedc8;\n      --paper-light-green-200: #c5e1a5;\n      --paper-light-green-300: #aed581;\n      --paper-light-green-400: #9ccc65;\n      --paper-light-green-500: #8bc34a;\n      --paper-light-green-600: #7cb342;\n      --paper-light-green-700: #689f38;\n      --paper-light-green-800: #558b2f;\n      --paper-light-green-900: #33691e;\n      --paper-light-green-a100: #ccff90;\n      --paper-light-green-a200: #b2ff59;\n      --paper-light-green-a400: #76ff03;\n      --paper-light-green-a700: #64dd17;\n\n      --paper-lime-50: #f9fbe7;\n      --paper-lime-100: #f0f4c3;\n      --paper-lime-200: #e6ee9c;\n      --paper-lime-300: #dce775;\n      --paper-lime-400: #d4e157;\n      --paper-lime-500: #cddc39;\n      --paper-lime-600: #c0ca33;\n      --paper-lime-700: #afb42b;\n      --paper-lime-800: #9e9d24;\n      --paper-lime-900: #827717;\n      --paper-lime-a100: #f4ff81;\n      --paper-lime-a200: #eeff41;\n      --paper-lime-a400: #c6ff00;\n      --paper-lime-a700: #aeea00;\n\n      --paper-yellow-50: #fffde7;\n      --paper-yellow-100: #fff9c4;\n      --paper-yellow-200: #fff59d;\n      --paper-yellow-300: #fff176;\n      --paper-yellow-400: #ffee58;\n      --paper-yellow-500: #ffeb3b;\n      --paper-yellow-600: #fdd835;\n      --paper-yellow-700: #fbc02d;\n      --paper-yellow-800: #f9a825;\n      --paper-yellow-900: #f57f17;\n      --paper-yellow-a100: #ffff8d;\n      --paper-yellow-a200: #ffff00;\n      --paper-yellow-a400: #ffea00;\n      --paper-yellow-a700: #ffd600;\n\n      --paper-amber-50: #fff8e1;\n      --paper-amber-100: #ffecb3;\n      --paper-amber-200: #ffe082;\n      --paper-amber-300: #ffd54f;\n      --paper-amber-400: #ffca28;\n      --paper-amber-500: #ffc107;\n      --paper-amber-600: #ffb300;\n      --paper-amber-700: #ffa000;\n      --paper-amber-800: #ff8f00;\n      --paper-amber-900: #ff6f00;\n      --paper-amber-a100: #ffe57f;\n      --paper-amber-a200: #ffd740;\n      --paper-amber-a400: #ffc400;\n      --paper-amber-a700: #ffab00;\n\n      --paper-orange-50: #fff3e0;\n      --paper-orange-100: #ffe0b2;\n      --paper-orange-200: #ffcc80;\n      --paper-orange-300: #ffb74d;\n      --paper-orange-400: #ffa726;\n      --paper-orange-500: #ff9800;\n      --paper-orange-600: #fb8c00;\n      --paper-orange-700: #f57c00;\n      --paper-orange-800: #ef6c00;\n      --paper-orange-900: #e65100;\n      --paper-orange-a100: #ffd180;\n      --paper-orange-a200: #ffab40;\n      --paper-orange-a400: #ff9100;\n      --paper-orange-a700: #ff6500;\n\n      --paper-deep-orange-50: #fbe9e7;\n      --paper-deep-orange-100: #ffccbc;\n      --paper-deep-orange-200: #ffab91;\n      --paper-deep-orange-300: #ff8a65;\n      --paper-deep-orange-400: #ff7043;\n      --paper-deep-orange-500: #ff5722;\n      --paper-deep-orange-600: #f4511e;\n      --paper-deep-orange-700: #e64a19;\n      --paper-deep-orange-800: #d84315;\n      --paper-deep-orange-900: #bf360c;\n      --paper-deep-orange-a100: #ff9e80;\n      --paper-deep-orange-a200: #ff6e40;\n      --paper-deep-orange-a400: #ff3d00;\n      --paper-deep-orange-a700: #dd2c00;\n\n      --paper-brown-50: #efebe9;\n      --paper-brown-100: #d7ccc8;\n      --paper-brown-200: #bcaaa4;\n      --paper-brown-300: #a1887f;\n      --paper-brown-400: #8d6e63;\n      --paper-brown-500: #795548;\n      --paper-brown-600: #6d4c41;\n      --paper-brown-700: #5d4037;\n      --paper-brown-800: #4e342e;\n      --paper-brown-900: #3e2723;\n\n      --paper-grey-50: #fafafa;\n      --paper-grey-100: #f5f5f5;\n      --paper-grey-200: #eeeeee;\n      --paper-grey-300: #e0e0e0;\n      --paper-grey-400: #bdbdbd;\n      --paper-grey-500: #9e9e9e;\n      --paper-grey-600: #757575;\n      --paper-grey-700: #616161;\n      --paper-grey-800: #424242;\n      --paper-grey-900: #212121;\n\n      --paper-blue-grey-50: #eceff1;\n      --paper-blue-grey-100: #cfd8dc;\n      --paper-blue-grey-200: #b0bec5;\n      --paper-blue-grey-300: #90a4ae;\n      --paper-blue-grey-400: #78909c;\n      --paper-blue-grey-500: #607d8b;\n      --paper-blue-grey-600: #546e7a;\n      --paper-blue-grey-700: #455a64;\n      --paper-blue-grey-800: #37474f;\n      --paper-blue-grey-900: #263238;\n\n      /* opacity for dark text on a light background */\n      --dark-divider-opacity: 0.12;\n      --dark-disabled-opacity: 0.38; /* or hint text or icon */\n      --dark-secondary-opacity: 0.54;\n      --dark-primary-opacity: 0.87;\n\n      /* opacity for light text on a dark background */\n      --light-divider-opacity: 0.12;\n      --light-disabled-opacity: 0.3; /* or hint text or icon */\n      --light-secondary-opacity: 0.7;\n      --light-primary-opacity: 1.0;\n\n    }\n\n  </style>\n</custom-style>";document.head.appendChild($_documentContainer$3.content);/**
                                                          ...
                                                          */ /* Taken from https://www.google.com/design/spec/style/color.html#color-ui-color-application */ /*
                                                                                                                                                               ...
                                                                                                                                                               from HTML and may be out of place here. Review them and
                                                                                                                                                               then delete this comment!
                                                                                                                                                             */;var $_documentContainer$5=document.createElement("template");$_documentContainer$5.setAttribute("style","display: none;");$_documentContainer$5.innerHTML="<dom-module id=\"paper-icon-button\">\n  <template strip-whitespace=\"\">\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        padding: 8px;\n        outline: none;\n        -webkit-user-select: none;\n        -moz-user-select: none;\n        -ms-user-select: none;\n        user-select: none;\n        cursor: pointer;\n        z-index: 0;\n        line-height: 1;\n\n        width: 40px;\n        height: 40px;\n\n        /* NOTE: Both values are needed, since some phones require the value to be `transparent`. */\n        -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n        -webkit-tap-highlight-color: transparent;\n\n        /* Because of polymer/2558, this style has lower specificity than * */\n        box-sizing: border-box !important;\n\n        @apply --paper-icon-button;\n      }\n\n      :host #ink {\n        color: var(--paper-icon-button-ink-color, var(--primary-text-color));\n        opacity: 0.6;\n      }\n\n      :host([disabled]) {\n        color: var(--paper-icon-button-disabled-text, var(--disabled-text-color));\n        pointer-events: none;\n        cursor: auto;\n\n        @apply --paper-icon-button-disabled;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      :host(:hover) {\n        @apply --paper-icon-button-hover;\n      }\n\n      iron-icon {\n        --iron-icon-width: 100%;\n        --iron-icon-height: 100%;\n      }\n    </style>\n\n    <iron-icon id=\"icon\" src=\"[[src]]\" icon=\"[[icon]]\" alt$=\"[[alt]]\"></iron-icon>\n  </template>\n\n  \n</dom-module>";document.head.appendChild($_documentContainer$5.content);Polymer({is:"paper-icon-button",hostAttributes:{role:"button",tabindex:"0"},behaviors:[PaperInkyFocusBehavior],properties:{/**
...
if(!label||oldValue==label){this.setAttribute("aria-label",newValue)}}});var styleElement=document.createElement("template");styleElement.innerHTML="<iron-iconset-svg size=\"24\" name=\"carousel\">\n<svg>\n  <defs>\n    <g id=\"arrow-back\">\n      <path d=\"M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z\"></path>\n    </g>\n    <g id=\"arrow-downward\">\n      <path d=\"M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z\"></path>\n    </g>\n    <g id=\"arrow-forward\">\n      <path d=\"M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z\"></path>\n    </g>\n    <g id=\"arrow-upward\">\n      <path d=\"M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z\"></path></g>\n    <g id=\"radio-button-checked\">\n      <path d=\"M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z\"></path>\n    </g>\n    <g id=\"radio-button-unchecked\">\n      <path d=\"M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z\"></path>\n    </g>\n  </defs>\n</svg>\n</iron-iconset-svg>";document.head.appendChild(styleElement.content);var SkeletonCarousel=/*#__PURE__*/function(_mixinBehaviors2){babelHelpers.inherits(SkeletonCarousel,_mixinBehaviors2);function SkeletonCarousel(){babelHelpers.classCallCheck(this,SkeletonCarousel);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SkeletonCarousel).apply(this,arguments))}babelHelpers.createClass(SkeletonCarousel,[{key:"connectedCallback",/**
     * Ready event
     */value:function connectedCallback(){var _this33=this;babelHelpers.get(babelHelpers.getPrototypeOf(SkeletonCarousel.prototype),"connectedCallback",this).call(this);var container=this.shadowRoot.querySelector("slot"),carousel=this.shadowRoot.querySelector("#carousel");// Allow vertical scrolling
addListener(carousel,"track",this._drag.bind(this));this.setScrollDirection("all",carousel);new FlattenedNodesObserver(container,function(){_this33._children=FlattenedNodesObserver.getFlattenedNodes(_this33).filter(function(n){return n.nodeType===Node.ELEMENT_NODE&&"DOM-REPEAT"!==n.nodeName&&"TEMPLATE"!==n.nodeName})});// Handle transition end
var items=this.shadowRoot.querySelector("#items");items.addEventListener("transitionend",function(e){e.preventDefault();if(_this33.swiping||"transform"!==e.propertyName){return}_this33._setAnimating(!1)})}/**
     * @return {Array}
     */},{key:"_computeSelectedItem",/**
     ...
     * @return {object}
     * @private
     */value:function _computeSelectedItem(selected,children){return children[selected]}/**
     * Children change observer
     *
     * @param {array} children
     * @private
     */},{key:"_childrenObserver",value:function _childrenObserver(children){this._setTotal(children.length);this._lazyContent(0);if(1<=children.length)this._lazyContent(1)}/**
     * Go to the previous slide with keybindings
     *
     * @param {object} event
     * @private
     * @return {*}
     */},{key:"_prevKey",value:function _prevKey(event){if(this.disableKeys||this.disabled)return;event.preventDefault();return this.prev()}/**
     * Go to the next slide with keybindings
     *
     * @param {object} event
     * @private
     * @return {*}
     */},{key:"_nextKey",value:function _nextKey(event){if(this.disableKeys||this.disabled)return;event.preventDefault();return this.next()}/**
     * Observer on auto to turn on and off the feature
     *
     * @param {boolean} auto
     * @private
     */},{key:"_autoAnimate",value:function _autoAnimate(auto){var _this34=this;if(auto){this._autoInterval=setInterval(function(){_this34.next()},this.duration)}else{clearInterval(this._autoInterval)}}/**
     * Go to next slide
     */},{key:"next",value:function next(){if(this.disabled)return;var element=this.shadowRoot.querySelector("#container"),total=this.total;if(this.selected<--total||this.loop){this._setAnimating(!0);element.selectNext()}}/**
     * Go to previous slide
     */},{key:"prev",value:function prev(){if(this.disabled)return;var element=this.shadowRoot.querySelector("#container");if(0<this.selected||this.loop){this._setAnimating(!0);element.selectPrevious()}}/**
     ...
     * @return {string}
     * @private
     */},{key:"_iconDot",value:function _iconDot(item,selected){item--;var icon="carousel:radio-button-unchecked";if(+item===+selected)icon="carousel:radio-button-checked";return icon}/**
     * Listen for changes on the selected item
     *
     * @param {number} newValue
     * @param {number} oldValue
     * @private
     */},{key:"_selectedObserver",value:function _selectedObserver(newValue,oldValue){this._lazyContent(newValue);var total=this.total;if(newValue<--total){this._lazyContent(++newValue)}// Reset auto
this._autoAnimate(!1);this._autoAnimate(this.auto)}/**
     * Lazy load content for the given slider number
     * Replaces 'data-src' attribute to 'src'.
     *
     * @param {number} selected
     * @private
     */},{key:"_lazyContent",value:function _lazyContent(selected){var child=this._children[selected];if(!child)return;// lazy load first level content
if(child.hasAttribute("data-src")){child.src=child.getAttribute("data-src");child.removeAttribute("data-src")}// Lazy load child content
var content=child.querySelectorAll("[data-src]");if(0>=content.length)return;var i=0;for(i;i<content.length;++i){content[i].src=content[i].getAttribute("data-src");content[i].removeAttribute("data-src")}}/**
     ...
     * @return {boolean}
     * @private
     */},{key:"_computeShowNext",value:function _computeShowNext(disabled,total,selected,loop){if(disabled)return!1;if(loop)return!0;return selected<--total}/**
     * Determine if it should show the next button
     *
     * @param {boolean} disabled
     * @param {number} selected
     ...
     * @return {boolean}
     * @private
     */},{key:"_computeShowPrev",value:function _computeShowPrev(disabled,selected,loop){if(disabled)return!1;if(loop)return!0;return 0<selected}/**
     * Returns the dots array
     *
     * @param {number} total
     * @return {Array}
     * @private
     */},{key:"_computeDots",value:function _computeDots(total){var array=[];if(0>=total)return array;var i=1;total=++total;for(i;i<total;++i){array.push(i)}return array}/**
     ...
     * @return {boolean}
     * @private
     */},{key:"_computeEnd",value:function _computeEnd(total,selected){var status=selected===--total;if(status)this._event("end");return status}/**
     * Returns a valid value
     *
     * @param {number} value
     * @return {*}
     * @private
     */},{key:"_normalize",value:function _normalize(value){if(0>value){value=0}else if(1<value){value=1}return value}/**
     * Returns the percentage that will to position the icon
     *
     * @param {number|string} value
     * @return {string}
     * @private
     */},{key:"_calcPercentage",value:function _calcPercentage(value){value=value.toFixed(2);return"".concat(100*value,"%")}/**
     * Listen for track and move the container
     *
     * @param {object} event
     * @private
     */},{key:"_drag",value:function _drag(event){if(this.disableSwipe||this.disabled){// Reset selected to original in case is changed while dragging
this._x=0;this._y=0;this._setSwiping(!1);return}var width=this.offsetWidth,height=this.offsetHeight,x=event.detail.ddx?event.detail.ddx:0,y=event.detail.ddy?event.detail.ddy:0,finalX=x/width,finalY=y/height,finalLeft=0,finalTop=0;if("horizontal"===this.direction)finalLeft=this._x+finalX;if("vertical"===this.direction)finalTop=this._y+finalY;var finalPositionLeft=+finalLeft,finalPositionTop=+finalTop;// Prevent drag to the wrong direction if is not available
if(!this.showPrev){if(0<finalPositionLeft){finalPositionLeft=0}if(0<finalPositionTop){finalPositionTop=0}}if(!this.showNext){if(0>finalPositionLeft){finalPositionLeft=0}if(0>finalPositionTop){finalPositionTop=0}}switch(event.detail.state){case"track":this._autoAnimate(!1);this._x=finalPositionLeft;this._y=finalPositionTop;this._setSwiping(!0);break;case"end":this._autoAnimate(this.auto);this._x=0;this._y=0;this._setSwiping(!1);if(.1<=finalPositionLeft||.1<=finalPositionTop){this.prev()}else if(-.1>=finalPositionLeft||-.1>=finalPositionTop){this.next()}break;}}/**
     * Compute icon previews
     *
     * @param {string|null} direction
     * @return {string}
     * @private
     */},{key:"_computeIconPrev",value:function _computeIconPrev(direction){if("vertical"===direction)return"carousel:arrow-upward";return"carousel:arrow-back"}/**
     * Compute icon next
     *
     * @param {string|null} direction
     * @return {string}
     * @private
     */},{key:"_computeIconNext",value:function _computeIconNext(direction){if("vertical"===direction)return"carousel:arrow-downward";return"carousel:arrow-forward"}/**
     ...
     * @param {number} _y
     * @private
     */},{key:"_translateObserver",value:function _translateObserver(direction,selected,_x,_y){if(0!==_x||0!==_y){this._setAnimating(!0)}var finalX=0,finalY=0,baseSelected=-Math.abs(selected);if(0>=selected)baseSelected=0;if(0===_x&&0===_y){var percentage=this._calcPercentage(baseSelected);if("horizontal"===direction)finalX=percentage;if("vertical"===direction)finalY=percentage}else{// add baseSelected to the original value of the drag value
_x=baseSelected+_x;_y=baseSelected+_y;if("horizontal"===direction){finalX=this._calcPercentage(_x)}if("vertical"===direction){finalY=this._calcPercentage(_y)}}var element=this.shadowRoot.querySelector("#items"),transform="";if("horizontal"===direction){transform="translateX(".concat(finalX,")")}if("vertical"===direction){transform="translateY(".concat(finalY,")")}element.style.transform=transform}/**
     ...
     * @return {number}
     * @private
     */},{key:"_returnDragPosition",value:function _returnDragPosition(position,selected){return position-selected}/**
     ...
     * @return {string}
     * @private
     */},{key:"_computeContainerHeight",value:function _computeContainerHeight(direction,total){var height="auto";if("vertical"===direction)height=this._calcPercentage(total);return"height: ".concat(height,";")}/**
     * Compute Controls
     ...
     * @return {boolean}
     * @private
     */},{key:"_computeControls",value:function _computeControls(dots,nav,total){return 1<total&&(dots||nav)}/**
     * Fire event
     *
     * @param {string} name
     * @param {null|string|boolean} detail
     * @private
     */},{key:"_event",value:function _event(name){var detail=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"";this.dispatchEvent(new CustomEvent(name,{detail:detail,bubbles:!0,composed:!0}))}},{key:"keyBindings",/**
     * Key bindings
     * @return {object}
     */get:function get(){return{"left up":"_prevKey","right down":"_nextKey"}}}],[{key:"template",/**
   * Template element
   * @return {!HTMLTemplateElement}
   */get:function get(){return html(_templateObject7_f273f6d02caa11ea91a843ae9cba1c4a())}/**
     * @return {string}
     */},{key:"is",get:function get(){return"skeleton-carousel"}/**
     * @return {object}
     */},{key:"properties",get:function get(){return{/**
       * Indicates if the carousel is been animated (Transition)
       */animating:{type:Boolean,value:!1,readOnly:!0,reflectToAttribute:!0,notify:!0},/**
       * Change slides automatically
       */auto:{type:Boolean,value:!1,observer:"_autoAnimate"},/**
       * Carousel direction (horizontal or vertical)
       */direction:{type:String,value:"horizontal",reflectToAttribute:!0},/**
       * Disables component
       */disabled:{type:Boolean,value:!1},/**
       * Show navigation dots
       */dots:{type:Boolean,value:!1},/**
       * Disable swipe functionality
       */disableSwipe:{type:Boolean,value:!1},/**
       * Disable keyboard navigation
       */disableKeys:{type:Boolean,value:!1},/**
       * Auto play interval time in milliseconds
       */duration:{type:Number,value:4e3},/**
       ...
       */nav:{type:Boolean,value:!1},/**
       * Selected slide index
       */selected:{type:Number,value:0,notify:!0,reflectToAttribute:!0,observer:"_selectedObserver"},/**
       * Selected item
       */selectedItem:{type:Object,notify:!0,readOnly:!0,computed:"_computeSelectedItem(selected, _children)"},/**
       * The user is swiping
       */swiping:{type:Boolean,value:!1,notify:!0,readOnly:!0,reflectToAttribute:!0},/**
       * tabindex
       */tabindex:{type:Number,value:0,reflectToAttribute:!0},/**
       * Total number of slides
       */total:{type:Number,value:0,notify:!0,reflectToAttribute:!0,readOnly:!0},/**
       * Returns true when the carousel has reached the last slide.
       */end:{type:Boolean,value:!1,notify:!0,readOny:!0,reflectToAttribute:!0,computed:"_computeEnd(total, selected)"},/**
       * Determines if the next button should be displayed.
       */showNext:{type:Boolean,value:!1,computed:"_computeShowNext(disabled, total, selected, loop)",notify:!0,reflectToAttribute:!0,readOnly:!0},/**
       * Determines if the previous button should be displayed.
       */showPrev:{type:Boolean,value:!1,computed:"_computeShowPrev(disabled, selected, loop)",notify:!0,reflectToAttribute:!0,readOnly:!0},/**
       * Auto interval
       */_autoInterval:{type:Object},/**
       * Children elements
       */_children:{type:Array,value:[],observer:"_childrenObserver"},/**
       * Show navigation controls
       */_controls:{type:Boolean,value:!1,readOnly:!0,computed:"_computeControls(dots, nav, total)"},/**
       * Returns an array with the slides.
       * This will be used to create the dot controls.
       */_dots:{type:Array,computed:"_computeDots(total)",readOnly:!0,value:[]},/**
       * Icon for the previous button
       */_iconPrev:{type:String,value:"carousel:arrow-back",readOnly:!0,computed:"_computeIconPrev(direction)"},/**
       * Icon for the next button
       */_iconNext:{type:String,value:"carousel:arrow-forward",readOnly:!0,computed:"_computeIconNext(direction)"},/**
       * Icon for the next button
       */_containerHeight:{type:String,value:"height: 100%;",computed:"_computeContainerHeight(direction, total)",readOnly:!0},/**
       * X Axis position (0 - 1)
       */_x:{type:Number,value:0},/**
       * Y Axis position (0 - 1)
       */_y:{type:Number,value:0}}}},{key:"observers",get:function get(){return["_translateObserver(direction, selected, _x, _y)"]}}]);return SkeletonCarousel}(mixinBehaviors([IronA11yKeysBehavior,GestureEventListeners],PolymerElement));window.customElements.define("skeleton-carousel",SkeletonCarousel);var AllEnteriesPage=/*#__PURE__*/function(_PolymerElement2){babelHelpers.inherits(AllEnteriesPage,_PolymerElement2);function AllEnteriesPage(){babelHelpers.classCallCheck(this,AllEnteriesPage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(AllEnteriesPage).apply(this,arguments))}babelHelpers.createClass(AllEnteriesPage,[{key:"ready",value:function ready(){var _this35=this;babelHelpers.get(babelHelpers.getPrototypeOf(AllEnteriesPage.prototype),"ready",this).call(this);db.collection("news").orderBy("id","desc").limit(1).get().then(function(snapshot){snapshot.docs.forEach(function(doc){//this.$.ironImage.setAttribute('src', doc.data().img);     
_this35.$.headline.innerHTML=doc.data().title;_this35.$.blurb.innerHTML=doc.data().blurb;_this35.$.date.innerHTML=doc.data().date;_this35.$.plastic.setAttribute("srcset",doc.data().img)})});db.collection("news").orderBy("id","desc").get().then(function(snapshot){_this35.articles=[];snapshot.docs.forEach(function(doc){_this35.articles.push(doc.data())});_this35.articles.shift()})}}],[{key:"template",get:function get(){return html(_templateObject8_f273f6d02caa11ea91a843ae9cba1c4a())}}]);return AllEnteriesPage}(PolymerElement);window.customElements.define("all-enteries-page",AllEnteriesPage);var CnnvQuestions=/*#__PURE__*/function(_PolymerElement3){babelHelpers.inherits(CnnvQuestions,_PolymerElement3);function CnnvQuestions(){babelHelpers.classCallCheck(this,CnnvQuestions);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(CnnvQuestions).apply(this,arguments))}babelHelpers.createClass(CnnvQuestions,[{key:"ready",value:function ready(){var _this36=this;babelHelpers.get(babelHelpers.getPrototypeOf(CnnvQuestions.prototype),"ready",this).call(this);db.collection("qanda").orderBy("id","asc").get().then(function(snapshot){_this36.articles=[];snapshot.docs.forEach(function(doc){_this36.articles.push(doc.data())})})}}],[{key:"template",get:function get(){return html(_templateObject9_f273f6d02caa11ea91a843ae9cba1c4a())}}]);return CnnvQuestions}(PolymerElement);window.customElements.define("cnnv-questions",CnnvQuestions);var $_documentContainer$6=document.createElement("template");$_documentContainer$6.innerHTML="<dom-module id=\"shared-styles\">\n  <template>\n    <style>\n     :host {\n              --app-primary-color: #354463;\n              --app-secondary-color: black;\n              --app-button-color: #C1F7D5;\n              --app-content-wdith: 1200px;\n\n              --app-desktop-padding: 0 40px;\n              --app-tablet-padding: 0 64px;\n              --app-mobile-padding: 0 32px;\n               -app-mobile-medium-padding: 0 24px;\n              --app-mobile-small-padding: 0 16px;\n\n              --app-320-padding: 0 40px;\n              --app-375-padding: 0 40px;   \n              --app-425-padding: 0 40px; \n              --app-768-padding: 0 40px; \n              --app-1024-padding: 0 40px; \n              --app-1440-padding: 0 40px;                                            \n\n              --app-tablet-padding: 0 64px;\n              --app-mobile-padding: 0 32px; \n\n              --app-large-headline:  28px;\n              --app-medium-headline:  22px;       \n              --app-small-headline:  18px;      \n              --app-grid-column:  64px; \n              --app-grid-gutter:  32px;               \n               display: block;\n            }\n\n     .button {\n        padding: 12px 40px;\n        border-radius: 100px;\n        background-color: var(--app-button-color);\n      }    \n\nh2 {\n  font-family: poynter-oldstyle-display, serif;\n  font-weight: 700;\n}\n\n.accent {\n  font-family: flood-std, sans-serif;\nfont-weight: 400;\nfont-style: normal;\ncolor: #fff;\n    line-height: 1.1em;\n}\n\n.accent-small {\n  font-family: flood-std, sans-serif;\nfont-weight: 400;\nfont-style: normal;\n    color: var(--app-primary-color);\nfont-size: 32px;\ntext-align: right;\n    line-height: 1.2em;\n}\n\n.large-headline {\n  font-size: 44px;\n  font-family: poynter-oldstyle-display, serif;\n  font-weight: 700;\n      line-height: 1.22em;\n        color: var(--app-primary-color);\n}\n\n.small-headline {\n  font-size: 28px;\n  font-family: poynter-oldstyle-display, serif;\n  font-weight: 700;  \n}\n.headline-body-large {\n    color: var(--app-primary-color);\n   font-family: komet, sans-serif;\n   font-weight: 300;\n   font-size: 20px;\n     margin-top: 4px;\n     padding-right: 40px;\n     letter-spacing: -.25px;\n}\n\n.headline-body {\n    color: var(--app-primary-color);\n   font-family: komet, sans-serif;\n   font-weight: 300;\n   font-size: 16px;\n     margin-top: 4px;\n     padding-right: 40px;\n}\n\n.caption {\n     font-family: komet, sans-serif;\n   font-weight: 300;\n   font-size: 14px;\n   text-transform: uppercase;\n   letter-spacing: .5px; \n}\n\n.capitalize {\n    text-transform: capitalize;\n       letter-spacing: 0; \n}\n\n.button {\n    font-size: 18px;\n  font-family: poynter-oldstyle-display, serif;\n  font-weight: 700; \n   text-decoration: none;\n    color: var(--app-primary-color);   \n}\n\n\n           h5 {\n                 background-color: var(--app-primary-color);\n                 font-family: komet, sans-serif;\n                  font-weight: 400;\n                  font-size: 14px;\n                 color: white;\n                 box-sizing: border-box;\n                display: inline-block;\n    padding: 10px 20px 9px;\n                min-width: 160px;\n                position: absolute;\n                margin: -21px 0 0 0;\n                text-transform: uppercase;\n                text-align: center;\n                letter-spacing: 1px;\n          }\n\n          a {\n               font-family: komet, sans-serif;\n                 font-weight: 300;\n                 font-size: 16px;\n                 color:  var(--app-primary-color);\n                    letter-spacing: -.015em;\n          }\n\n\n\n\n @media only screen and (max-width: 768px) {\n\n.accent {\n  font-size: 44px;\n}\n\n.large-headline {\n  font-size:  36px;\n    font-family: poynter-oldstyle-display, serif;\n  font-weight: 700;\n  font-style: normal;\n  color: var(--app-primary-color);  \n}\n\n.small-headline {\n  font-size: 22px; \n}\n\n.headline-body {\n     padding-right: 0px;\n}\n\n\nh5 {\n      padding: 10px 14px 9px 14px;\n}\n }\n\n\n @media only screen and (max-width: 480px) {\n\n\n.large-headline {\n  font-size:  22px;\n}\n\n }\n\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$6.content);var EventsEnteriesPage=/*#__PURE__*/function(_PolymerElement4){babelHelpers.inherits(EventsEnteriesPage,_PolymerElement4);function EventsEnteriesPage(){babelHelpers.classCallCheck(this,EventsEnteriesPage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EventsEnteriesPage).apply(this,arguments))}babelHelpers.createClass(EventsEnteriesPage,[{key:"ready",value:function ready(){var _this37=this;babelHelpers.get(babelHelpers.getPrototypeOf(EventsEnteriesPage.prototype),"ready",this).call(this);db.collection("news").get().then(function(snapshot){_this37.articles=[];snapshot.docs.forEach(function(doc){_this37.articles.push(doc.data())})})}}],[{key:"template",get:function get(){return html(_templateObject10_f273f6d02caa11ea91a843ae9cba1c4a())}}]);return EventsEnteriesPage}(PolymerElement);window.customElements.define("events-enteries-page",EventsEnteriesPage);var LatestPost=/*#__PURE__*/function(_PolymerElement5){babelHelpers.inherits(LatestPost,_PolymerElement5);function LatestPost(){babelHelpers.classCallCheck(this,LatestPost);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LatestPost).apply(this,arguments))}babelHelpers.createClass(LatestPost,[{key:"ready",value:function ready(){var _this38=this;babelHelpers.get(babelHelpers.getPrototypeOf(LatestPost.prototype),"ready",this).call(this);db.collection("news").orderBy("id","desc").limit(1).get().then(function(snapshot){snapshot.docs.forEach(function(doc){_this38.$.ironImage.setAttribute("src",doc.data().img);_this38.$.headline.innerHTML=doc.data().title;_this38.$.body.innerHTML=doc.data().blurb;_this38.$.timestamp.innerHTML=doc.data().date})})}}],[{key:"template",get:function get(){return html(_templateObject11_f273f6d02caa11ea91a843ae9cba1c4a())}}]);return LatestPost}(PolymerElement);window.customElements.define("latest-post",LatestPost);var NewsEnteriesPage=/*#__PURE__*/function(_PolymerElement6){babelHelpers.inherits(NewsEnteriesPage,_PolymerElement6);function NewsEnteriesPage(){babelHelpers.classCallCheck(this,NewsEnteriesPage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(NewsEnteriesPage).apply(this,arguments))}babelHelpers.createClass(NewsEnteriesPage,[{key:"ready",value:function ready(){var _this39=this;babelHelpers.get(babelHelpers.getPrototypeOf(NewsEnteriesPage.prototype),"ready",this).call(this);db.collection("news").get().then(function(snapshot){_this39.articles=[];snapshot.docs.forEach(function(doc){_this39.articles.push(doc.data())})})}}],[{key:"template",get:function get(){return html(_templateObject12_f273f6d02caa11ea91a843ae9cba1c4a())}}]);return NewsEnteriesPage}(PolymerElement);window.customElements.define("news-enteries-page",NewsEnteriesPage);var PostPage=/*#__PURE__*/function(_PolymerElement7){babelHelpers.inherits(PostPage,_PolymerElement7);function PostPage(){babelHelpers.classCallCheck(this,PostPage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PostPage).apply(this,arguments))}babelHelpers.createClass(PostPage,[{key:"_routePageChanged",value:function _routePageChanged(post){var _this40=this;document.documentElement.scrollTop=0;this.$.mask.style.display="block";console.log("changed");db.collection("news").where("id","==",this.post).get().then(function(snapshot){snapshot.docs.forEach(function(doc){_this40.$.plastic.setAttribute("srcset",doc.data().img);_this40.$.headline.innerHTML=doc.data().title;_this40.$.date.innerHTML=doc.data().date;_this40.$.body.innerHTML=doc.data().body;//this.$.blurb.innerHTML = doc.data().blurb;
_this40.$.mask.style.display="none"})})}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PostPage.prototype),"ready",this).call(this)}}],[{key:"template",get:function get(){return html(_templateObject13_f273f6d02caa11ea91a843ae9cba1c4a())}},{key:"properties",get:function get(){return{post:{type:String,reflectToAttribute:!0}}}},{key:"observers",get:function get(){return["_routePageChanged(post)"]}}]);return PostPage}(PolymerElement);window.customElements.define("post-page",PostPage)});